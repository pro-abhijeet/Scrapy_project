...
class MyprojectSpider(scrapy.Spider):
    ...
    def subscription(self, response):
        ...
        yield scrapy.Request(url=course_page, callback=self.courses, cb_kwargs={'monthly': monthly_price, 'yearly': annual_price_per_month, 'monthly_currency': monthly_currency, "annual_currency": annual_currency})

    def courses(self, response, monthly, yearly, monthly_currency, annual_currency):
