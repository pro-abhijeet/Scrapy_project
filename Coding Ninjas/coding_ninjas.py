# -*- coding: utf-8 -*-
"""coding ninjas_updated_code.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nxq3NruAErC562asWIUP357MKZxFt-EN
"""
...
class MainSpider(scrapy.Spider):
    ...
    def parse_info(self, response):
        ...
        for i in data1['data']['course_data']['faqs']:
            faq_ques.append(i['faq_title'])
            
            faq_ans.append([i['faq_description']][0])
        faq_question = '|'.join(faq_ques)
        faq_answer = '|'.join(faq_ans)
        ...
        for i in data1['data']['course_data']['support_system']['faculty']:
            ...
            fac_designation.append(i['designation'])

            fac_image.append(i['image_link'])
        instructor_name = '|'.join(fac_name)
        instructor_designation = '|'.join(fac_designation)
        instructor_image = '|'.join(fac_image)
        ...
        student_name = '|'.join(stud_name)
        student_review = '|'.join(stud_review)
